...
const gallery = stems.map((stem, index) => ({
  src: `../assets/images/${folder}/${stem}-1600.webp`,
  srcset: `../assets/images/${folder}/${stem}-640.webp 640w, ../assets/images/${folder}/${stem}-960.webp 960w, ../assets/images/${folder}/${stem}-1600.webp 1600w`,
  thumb: `../assets/images/${folder}/${stem}-640.webp`,
